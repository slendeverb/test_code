...
void QtCalculator::initUI()
{
	...
	// 2. 关联按钮组的点击信号
	connect(buttonGroup, static_cast<void (QButtonGroup::*)(QAbstractButton*)>(&QButtonGroup::buttonClicked), this, &QtCalculator::onButtonGroupClicked);
	vec.resize(5);
}

void QtCalculator::onButtonGroupClicked(QAbstractButton* btn)
{
