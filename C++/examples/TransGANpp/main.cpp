...
struct TransGANppGeneratorImpl : torch::nn::Module
{
	...
	TransGANppGeneratorImpl(
		...
		int n_layers = 3
			...
			input(torch::nn::LinearOptions(kNoiseSize, kNoiseSize * 4/*����� ������������������ ��� patch_size = 16 � �������� 28 �� 28*/).bias(false)),
...
struct TransGANppDiscriminatorImpl : torch::nn::Module
{
	...
	TransGANppDiscriminatorImpl(
		...
		int n_layers = 3
			...
			patch_embed(torch::nn::Conv2dOptions(1, embed_dim, patch_size).stride(patch_size).padding(2/*6*/).bias(false)),		//������� ���� � ����� �������� ������� ������������������ ������� ����� 4
			...
			transformer_encoder(transformer_encoder_layers, n_layers),
			head(torch::nn::LinearOptions(embed_dim * 4/*����� ������������������ ��� patch_size = 16 � �������� 28 �� 28*/, 1).bias(false))
	{
