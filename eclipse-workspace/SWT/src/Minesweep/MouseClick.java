...
public class MouseClick implements MouseListener {
	...
	AudioPlayer man = new AudioPlayer("src/Minesweep/man.wav");
	AudioPlayer manbaOut = new AudioPlayer("src/Minesweep/manba out.wav");
	AudioPlayer whatcanic = new AudioPlayer("src/Minesweep/what can i say.wav");
	AudioPlayer win = new AudioPlayer("src/Minesweep/win.wav");
